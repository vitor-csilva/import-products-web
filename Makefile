REPO=vitorcostasilva/import-products
TAG=31.0
...
build2:
	@docker build --platform linux/amd64 -t vitorcostasilva/import-products:$(TAG) .
	@make push

push:
	@docker push vitorcostasilva/import-products:$(TAG)
...
helm-deploy:
	@docker build -t $(REPO):$(TAG) -f ./k8s/helm/import-products/Dockerfile .